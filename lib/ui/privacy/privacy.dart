...
<div class="row mt-12 pt-3">
            ...
            <h2>Use of Data</h2>
            <p>https://airotrack.in/ uses the collected data for various purposes:</p>
            <ul>
            ...
            <p>https://airotrack.in/  will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
            <h2>Disclosure Of Data</h2>
            <h3>Legal Requirements</h3>
            <p>https://airotrack.in/ may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of ttps://airotrack.in/</li>
            ...
            <ul>
            <li>By email: info@airotrack.in</li>
            </ul>
            </div>
            </div>
            </div>
